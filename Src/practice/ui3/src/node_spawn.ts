...
export default class SpawnNode {
  ...
  static Boolean(pos:Vec2) {
    const node = new Node(null, 'Boolean', new Rect(pos.x, pos.y, 200, 100));
  ...
  static Number(pos:Vec2) {
    const node = new Node(null, 'Number', new Rect(pos.x, pos.y, 200, 100));
  ...
  static String(pos:Vec2) {
    const node = new Node(null, 'String',new Rect(pos.x, pos.y, 200, 100));
